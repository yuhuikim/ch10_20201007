...
<body>
	<div class="container" align="center">
					...
					<tr>
						...
						<c:if test="${board.del != 'y' }">
							<td title="${board.content }">
								...
								href="${path}/view/num/${board.num}/pageNum/${pb.currentPage}"
		...
		<form action="${path}/list/pageNum/1">
			<select name="search">
				<c:forTokens var="item" items="writer,subject,content,subcon"
					delims="," varStatus="i">
		...
		<a href="${path}/insertForm/nm/null/pageNum/1" class="btn btn-info">게시글
			입력</a>
	</div>
</body>
</html>